...
import DateField from 'components/elements/forms/date'
...
const ProfileEditForm = ({ handleSubmit }) => (
  <Fragment>
    <Form onSubmit={handleSubmit}>
      ...
      <DateField name="dob" label={t('forn.dob')} autoComplete="birthday" />
      ...
      <SelectCountry name="country" type="text" label={t('forn.country')} icon="globe" autoComplete="shipping country" />
