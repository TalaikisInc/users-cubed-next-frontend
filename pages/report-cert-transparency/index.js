...
class ReportCertTransparency extends Component {
  ...
  render () {
    ...
    const url = locale !== 'en' ? `${URL}/report-cert-transparency/${locale}` : `${URL}/report-cert-transparency`

    return (
      <Page title={t('contact.cert')} description={DESCRIPTIONS.contactUs} path={url} locale={locale}>
