...
class ReferUse extends Component {
  constructor (props) {
    super(props)
  ...
  render () {
    ...
    return (
      <Page title={t('confirm.title')} description={DESCRIPTIONS.confirm} path={url} locale={locale}>
        { status ? <Message>{t('confirm.done')}<a href={signinUrl}>{t('form.signin')}</a>.</Message>
